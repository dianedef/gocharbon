...
author: Diane
description: 'Tutoriel pratique pour configurer les permissions de Codex : étapes propres, erreurs à éviter et mise en place sans blabla.'
pubDate: 2026-04-19
...
Si tu veux configurer les permissions de Codex, le vrai sujet n'est pas d'enlever des popups. Le vrai sujet, c'est de choisir un niveau d'autonomie cohérent avec ta machine, ton projet et ton seuil de risque.
...
- OpenAI documente `approval_policy` et `sandbox_mode` dans sa documentation officielle Codex : https://developers.openai.com/codex/cli
