  ...
  questions: [
    {
      ...
      options: [
        { text: "Générer du cash rapidement", icon: "💸", points: { service: 4, ecommerce: 1 }, prefill: { questionId: 9, optionIndex: 0 } },
        ...
        { text: "Créer une audience", icon: "📣", points: { content: 4, formation: 1 }, prefill: { questionId: 9, optionIndex: 3 } },
      ],
    },
    {
      id: 2,
      ...
      options: [
        { text: "Oui, créatif (musique, vidéo, écriture, design)", icon: "🎨", points: { content: 4, formation: 1 }, prefill: { questionId: 16, optionIndex: 1 } },
        ...
        { text: "Pas encore", icon: "🌱", points: { content: 2, ecommerce: 2, service: 1 }, prefill: { questionId: 17, optionIndex: 3 } },
      ],
    },
    {
      id: 3,
      ...
      options: [
        ...
        { text: "10 à 15h", icon: "📅", points: { service: 2, content: 3 }, prefill: { questionId: 4, optionIndex: 1 } },
        { text: "20 à 30h", icon: "🚀", points: { ecommerce: 3, service: 2, saas: 1 }, prefill: { questionId: 4, optionIndex: 2 } },
    ...
    },
    {
      ...
      options: [
        { text: "0 à 100€", icon: "🪙", points: { service: 2, content: 3, formation: 1 }, prefill: { questionId: 3, optionIndex: 0 } },
        { text: "100 à 500€", icon: "💶", points: { service: 2, formation: 2, ecommerce: 1, content: 1 }, prefill: { questionId: 3, optionIndex: 1 } },
    ...
    },
    {
      ...
      options: [
        { text: "Clients en direct", icon: "🤝", points: { service: 4, formation: 1 }, prefill: { questionId: 7, optionIndex: 1 } },
        { text: "Produit à scaler", icon: "🧱", points: { saas: 3, ecommerce: 2 }, prefill: { questionId: 7, optionIndex: 2 } },
        { text: "Audience + contenu", icon: "📱", points: { content: 4, formation: 2 }, prefill: { questionId: 7, optionIndex: 3 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Équilibré", icon: "⚖️", points: { ecommerce: 2, content: 3, service: 1 }, prefill: { questionId: 6, optionIndex: 1 } },
    ...
    },
    {
      ...
      options: [
        { text: "Faible", icon: "🙂", points: { service: 2, formation: 2, content: 2 }, prefill: { questionId: 11, optionIndex: 0 } },
        { text: "No-code ok", icon: "🧰", points: { ecommerce: 2, content: 3, service: 1 }, prefill: { questionId: 11, optionIndex: 1 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Ventes produits", icon: "🛒", points: { ecommerce: 4, formation: 1 }, prefill: { questionId: 10, optionIndex: 2 } },
        { text: "Mix de revenus", icon: "🧩", points: { content: 3, formation: 2, ecommerce: 1 }, prefill: { questionId: 10, optionIndex: 3 } },
      ],
    },
  ],
