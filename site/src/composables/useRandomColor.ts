...
const colors = {
  light: [
    designTokens.light["semantic.color.actionPrimary"],
    designTokens.light["semantic.color.actionSecondary"],
    designTokens.light["semantic.color.surface"],
    designTokens.light["semantic.color.textMuted"],
  ],
  dark: [
    designTokens.dark["semantic.color.actionPrimary"],
    designTokens.dark["semantic.color.actionSecondary"],
    designTokens.dark["semantic.color.surface"],
    designTokens.dark["semantic.color.textMuted"],
  ],
} as const;
...
export function useRandomColor(props?: ColorProps) {
   ...
   * @returns {string} Canonical CSS color value.
   */
