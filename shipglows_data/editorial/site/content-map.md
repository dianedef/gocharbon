...
next_step: "/sf-docs verify shipglows_data/editorial/site/content-map.md"
---
...
|---|---|---|---|---|---|
| Landing page | `site/src/pages/index.astro` | Promesse principale, accès aux parcours | Astro | `README.md`, `shipglows_data/product/site/product.md`, `shipglows_data/gtm/site/gtm.md`, `shipglows_data/branding/branding.md` | Changement de positionnement public |
...
| Contenus de marque | `site/src/data/_founder.md`, `site/src/data/_vision.md`, `site/src/content/` | Ton, mission, cadre de confiance | Markdown | `shipglows_data/branding/branding.md`, `shipglows_data/technical/site/README.md` | Changement de ton / vision |
...
| SEO support | `site/src/data/seo`, `site/src/data/strategies` | Référencement et architecture sémantique | Markdown | `shipglows_data/technical/site/README.md`, `site/src/content/parcours` | Nouvel angle de recherche |
...
| Confiance & marque | `site/src/pages/bio.astro` | `site/src/data/_founder.md`, `site/src/data/_vision.md` | Crédibilité | Ton cohérent avec `shipglows_data/branding/branding.md` | live |
...
- Préférer `README.md` et `shipglows_data/product/site/product.md` quand la mise à jour touche la stratégie produit.
- Utiliser `shipglows_data/gtm/site/gtm.md` pour les évolutions de promesse, promesse commerciale, ou canaux d'acquisition.
...
|---|---|
| Changement de positionnement de marque | `shipglows_data/product/site/product.md`, `shipglows_data/gtm/site/gtm.md`, `shipglows_data/branding/branding.md`, `site/src/pages/index.astro` |
...
| Nouveau bloc de preuve ou source | `shipglows_data/product/site/product.md`, `shipglows_data/gtm/site/gtm.md`, pages liées, audit tracker |
