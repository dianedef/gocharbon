...
|---|---:|:---:|---|
| [myGEOscore](https://betalist.com/startups/mygeoscore) | Fiche outil / concurrent SEO IA | 9/10 | Très bon sujet "GEO: comment savoir si ton site est visible dans ChatGPT/Perplexity". Peut devenir fiche outil + guide pratique. |
