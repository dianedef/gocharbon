...
linked_systems:
  ...
  - "/home/claude/gocharbon/shipglows_data/technical/site/architecture.md"
...
depends_on:
  ...
  - artifact: "/home/claude/gocharbon/shipglows_data/technical/site/context.md"
    ...
    required_status: reviewed
  - artifact: "/home/claude/gocharbon/shipglows_data/technical/site/architecture.md"
    artifact_version: "1.0.0"
    required_status: reviewed
supersedes: []
evidence:
...
- Mise à jour des docs techniques/fonctionnelles qui décrivent la dépendance ou le stack runtime (`CLAUDE.md`, `shipglows_data/technical/site/context.md`, `shipglows_data/technical/site/architecture.md`, éventuellement README si impacté).
...
- checklist_path: `shipglows_data/workflow/test-checklists/gocharbon-gamification-dependency-hardening.md`
...
- `shipglows_data/technical/site/context.md` et `shipglows_data/technical/site/architecture.md` décrivent la couche gamification et la dépendance externe.
...
4. Réaligner la documentation.
   - Corriger `CLAUDE.md`, `shipglows_data/technical/site/context.md`, `shipglows_data/technical/site/architecture.md`, et tout autre contrat touché.
...
- Rechercher tous les imports et références:
  - `rg -n '@diane-winflowz/gamification|gamification_charbon|useGamification|fireBadgeConfetti|AchievementToast' src package.json pnpm-lock.yaml shipglows_data`
