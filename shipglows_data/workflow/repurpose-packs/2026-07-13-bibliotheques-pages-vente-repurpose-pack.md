...
source_ref:
  - "/home/claude/shipglowz/shipglows_data/workflow/research/bibliotheques-pages-vente-inspiration-visuelle-copywriting.md"
...
- Surface: présent pack sous `shipglows_data/workflow/repurpose-packs/`.
...
- Owner skill: `200-sg-redact`.
  Recommended command: `/200-sg-redact rédiger pour GoCharbon un article public à partir de shipglows_data/workflow/repurpose-packs/2026-07-13-bibliotheques-pages-vente-repurpose-pack.md`.
...
- Owner skill: `300-sg-docs`.
  ...
  Source proof: seul `shipglows_data/editorial/site/content-map.md` est présent dans le dossier éditorial.
