...
depends_on:
  - artifact: "/home/claude/gocharbon/shipglows_data/workflow/specs/gocharbon-gamification-dependency-provenance-and-licensing-hardening.md"
    artifact_version: "1.0.0"
...
```bash
rg -n '@diane-winflowz/gamification|github:dianedef/gamification|minimum-release-age|useGamification|fireBadgeConfetti|AchievementToast' package.json .npmrc pnpm-lock.yaml src shipglows_data
