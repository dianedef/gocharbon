...
next_step: "/sf-docs verify shipglows_data/gtm/site/gtm.md"
---
...
- Alignement de marque sur la voix anti-bullshit deja documente dans `shipglows_data/branding/branding.md`.
