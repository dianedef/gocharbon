...
next_step: "/sf-docs verify shipglowz_data/editorial/site/content-map.md"
---
...
|---|---|---|---|---|---|
| Landing page | `site/src/pages/index.astro` | Promesse principale, accès aux parcours | Astro | `README.md`, `shipglowz_data/product/site/product.md`, `shipglowz_data/gtm/site/gtm.md`, `shipglowz_data/branding/branding.md` | Changement de positionnement public |
...
| Contenus de marque | `site/src/data/_founder.md`, `site/src/data/_vision.md`, `site/src/content/` | Ton, mission, cadre de confiance | Markdown | `shipglowz_data/branding/branding.md`, `shipglowz_data/technical/site/README.md` | Changement de ton / vision |
...
| SEO support | `site/src/data/seo`, `site/src/data/strategies` | Référencement et architecture sémantique | Markdown | `shipglowz_data/technical/site/README.md`, `site/src/content/parcours` | Nouvel angle de recherche |
...
| Confiance & marque | `site/src/pages/bio.astro` | `site/src/data/_founder.md`, `site/src/data/_vision.md` | Crédibilité | Ton cohérent avec `shipglowz_data/branding/branding.md` | live |
...
- Préférer `README.md` et `shipglowz_data/product/site/product.md` quand la mise à jour touche la stratégie produit.
- Utiliser `shipglowz_data/gtm/site/gtm.md` pour les évolutions de promesse, promesse commerciale, ou canaux d'acquisition.
...
|---|---|
| Changement de positionnement de marque | `shipglowz_data/product/site/product.md`, `shipglowz_data/gtm/site/gtm.md`, `shipglowz_data/branding/branding.md`, `site/src/pages/index.astro` |
...
| Nouveau bloc de preuve ou source | `shipglowz_data/product/site/product.md`, `shipglowz_data/gtm/site/gtm.md`, pages liées, audit tracker |
