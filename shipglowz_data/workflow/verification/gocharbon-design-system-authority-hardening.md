...
docs_impact: yes
linked_systems:
  - "/home/claude/gocharbon/shipglowz_data/technical/site/design-system-authority.md"
  - "/home/claude/gocharbon/shipglowz_data/workflow/specs/gocharbon-design-system-authority-hardening.md"
  - "/home/claude/gocharbon/site/src/styles/global.css"
depends_on:
  - artifact: "/home/claude/gocharbon/shipglowz_data/technical/site/design-system-authority.md"
    artifact_version: "1.0.0"
    required_status: draft
  - artifact: "/home/claude/gocharbon/shipglowz_data/workflow/specs/gocharbon-design-system-authority-hardening.md"
    artifact_version: "1.0.0"
    required_status: draft
supersedes: []
...
| --- | --- | --- |
| `DSA-GO-001` | Fichier `shipglowz_data/technical/site/design-system-authority.md` existe et définit un carrier visuel unique + règles. | PASS |
...
| `DSA-GO-004` | `shipglowz_data/technical/site/design-system-authority.md` est réutilisé dans la spec + vérification (dépendances). | PASS |
...
python3 /home/claude/shipglowz/tools/shipglowz_metadata_lint.py \
  ...
  shipglowz_data/workflow/specs/gocharbon-design-system-authority-hardening.md \
  shipglowz_data/workflow/verification/gocharbon-design-system-authority-hardening.md
