...
linked_systems:
  ...
  - "/home/claude/gocharbon/shipglowz_data/technical/site/context.md"
depends_on:
  - artifact: "/home/claude/gocharbon/shipglowz_data/business/business.md"
    artifact_version: "1.0.0"
    required_status: reviewed
  - artifact: "/home/claude/gocharbon/shipglowz_data/technical/site/context.md"
    artifact_version: "1.0.1"
    required_status: reviewed
  - artifact: "/home/claude/gocharbon/shipglowz_data/technical/site/architecture.md"
    artifact_version: "1.0.0"
    required_status: reviewed
supersedes: []
evidence:
...
- Mise à jour des docs techniques/fonctionnelles qui décrivent la dépendance ou le stack runtime (`CLAUDE.md`, `shipglowz_data/technical/site/context.md`, `shipglowz_data/technical/site/architecture.md`, éventuellement README si impacté).
...
- checklist_path: `shipglowz_data/workflow/test-checklists/gocharbon-gamification-dependency-hardening.md`
...
- `shipglowz_data/technical/site/context.md` et `shipglowz_data/technical/site/architecture.md` décrivent la couche gamification et la dépendance externe.
...
4. Réaligner la documentation.
   - Corriger `CLAUDE.md`, `shipglowz_data/technical/site/context.md`, `shipglowz_data/technical/site/architecture.md`, et tout autre contrat touché.
...
- Rechercher tous les imports et références:
  - `rg -n '@diane-winflowz/gamification|gamification_charbon|useGamification|fireBadgeConfetti|AchievementToast' src package.json pnpm-lock.yaml shipglowz_data`
