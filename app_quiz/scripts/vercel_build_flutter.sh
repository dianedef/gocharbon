...
APP_PUBLIC_URL_VALUE="${APP_PUBLIC_URL:-}"
...
for firebase_define in CONVEX_HTTP_URL APP_PUBLIC_URL FIREBASE_API_KEY FIREBASE_APP_ID FIREBASE_MESSAGING_SENDER_ID FIREBASE_PROJECT_ID FIREBASE_AUTH_DOMAIN FIREBASE_STORAGE_BUCKET FIREBASE_MEASUREMENT_ID; do
