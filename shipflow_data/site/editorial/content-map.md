...
depends_on:
  - artifact: "shipflow_data/site/business/product.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
  - artifact: "shipflow_data/site/business/gtm.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
supersedes: []
next_review: "2026-05-26"
next_step: "/sf-docs verify shipflow_data/site/editorial/content-map.md"
---
...
|---|---|---|---|---|---|
| Landing page | `src/pages/index.astro` | Promesse principale, accès aux parcours | Astro | `README.md`, `shipflow_data/site/business/product.md`, `shipflow_data/site/business/gtm.md`, `shipflow_data/site/business/branding.md` | Changement de positionnement public |
...
| Contenus de marque | `src/data/_founder.md`, `src/data/_vision.md`, `src/content/` | Ton, mission, cadre de confiance | Markdown | `shipflow_data/site/business/branding.md`, `shipflow_data/technical/README.md` | Changement de ton / vision |
...
| Confiance & marque | `src/pages/bio.astro` | `src/data/_founder.md`, `src/data/_vision.md` | Crédibilité | Ton cohérent avec `shipflow_data/site/business/branding.md` | live |
...
- Préférer `README.md` et `shipflow_data/site/business/product.md` quand la mise à jour touche la stratégie produit.
- Utiliser `shipflow_data/site/business/gtm.md` pour les évolutions de promesse, promesse commerciale, ou canaux d'acquisition.
...
|---|---|
| Changement de positionnement de marque | `shipflow_data/site/business/product.md`, `shipflow_data/site/business/gtm.md`, `shipflow_data/site/business/branding.md`, `src/pages/index.astro` |
...
| Nouveau bloc de preuve ou source | `shipflow_data/site/business/product.md`, `shipflow_data/site/business/gtm.md`, pages liées, audit tracker |
