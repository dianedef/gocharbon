...
next_step: "/sf-docs verify shipflow_data/technical/app_quiz/guidelines.md"
---
...
- Si une route ou un payload change, mettre à jour `shipflow_data/technical/app_quiz/API.md`.
