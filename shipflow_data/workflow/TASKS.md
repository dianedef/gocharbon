...
<!-- central-shipflow-data-retirement: imported projects/gocharbon/TASKS.md -->

## Legacy Imported From Central ShipFlow Data

The following content was preserved from `/home/claude/shipflow_data/projects/gocharbon/TASKS.md` during central repository retirement. Treat it as historical backlog/context unless an item is promoted into the active section above.
