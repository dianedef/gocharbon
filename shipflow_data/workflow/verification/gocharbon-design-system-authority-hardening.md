...
| --- | --- | --- |
| `DSA-GO-001` | Fichier `shipflow_data/technical/design-system-authority.md` existe et définit un carrier visuel unique + règles. | PASS |
...
| `DSA-GO-004` | `shipflow_data/technical/design-system-authority.md` est réutilisé dans la spec + vérification (dépendances). | PASS |
